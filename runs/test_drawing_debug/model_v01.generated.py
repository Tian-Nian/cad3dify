...
# Conservative assumption: M6 holes are through holes based on top view representation
# The JSON notes uncertainty about hole depth, choosing through-all as most conservative
...
# =============================================================================
# Step 4: Add fillet on outer top edge
# =============================================================================
# Select the top outer edge of the upper flange section
flange = (
    flange
    .faces(">Z")
    .edges("%Circle")
    .edges(cq.selectors.RadiusNthSelector(0))  # Select outermost circular edge
    .fillet(fillet_radius)
)

# =============================================================================
# Step 5: Create 12x M6 through holes on bolt circle
# =============================================================================
...
# Export to STEP file
# =============================================================================
exporters.export(flange, "/home/user/project/cad3dify/runs/test_drawing_debug/output_v01.step")
